...
1.3 Résumé succinct de la documentation 

2 Rappel du cahier des charges (cdc) 6
...
2.5 Matériel et outils nécessaires 

3 Méthodologie et plannification 10
3.1 Choix de la méthodologie de travail 
3.2 Gestion des tâches et planification 
3.3 Gestion des versions et sauvegardes 

4 Tests et Validation 14
4.1 Procédure de tests 
4.2 Journal de tests 
4.3 Rapport de tests 

5 Analyse fonctionnelle 18
5.1 Identification des besoins 
5.2 Cas d’utilisation 
5.3 Description des fonctionnalités détaillées 
5.4 Contraintes et exigences techniques 

6 Analyse Organique 20
6.1 Architecture et programmation 
6.2 Base de données 
6.3 Diagramme de classes 
6.4 Description des fonctionnalités principales 
6.5 Utilisation des design patterns 

7 Conclusion et réflexion personnelle 22
7.1 Évaluation du respect du cahier des charges 
